...
const ALL_SHAPES: SplitShapeDef[] = [
  ...
  // THE PERFECT SPLIT CANDLE (Clean, Normal, No Drips)
  make('Candle', pts(
    62,8, 67,13, 68,20, 64,26, 58,29, 53,27, 51,21, 53,14,
    55,29, 55,36,
    59,37, 64,38, 69,39, 72,41,
    72,50, 72,62, 72,74, 72,86,
    72,92, 62,92, 50,92, 38,92, 28,92,
    28,86, 28,74, 28,62, 28,50, 28,41,
    32,40, 38,39, 45,38, 52,37
  )),

  // ANKER (Asymmetrisch geneigt)
  make('Anker', pts(
    50,5, 54,6, 56,10, 54,14, 50,15, 46,14, 44,10, 46,6,
    50,15, 68,18, 70,22, 68,26, 52,24,
    52,50,
    62,52, 74,56, 85,65, 88,75, 84,82, 75,80, 78,70, 65,62, 52,58,
    50,88, 48,88,
    35,62, 24,68, 16,74, 13,78, 12,72, 16,64, 25,56, 38,52,
    48,50, 48,24,
    32,22, 30,18, 32,14, 48,15
  )),
  ...
  // DONUT MIT BISS (Der ultimative Area-Killer)
  make('Donut mit Biss', pts(
    65,35, 62,30, 60,22, 65,15, 72,12,
    82,24, 88,34, 90,46, 90,58, 86,70, 78,80,
    68,88, 56,92, 44,92, 32,88,
    22,80, 14,70, 10,58, 10,46, 14,34, 22,24,
    32,14, 44,10, 56,11, 62,14
  )),
