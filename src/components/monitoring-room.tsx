    ...
    <main className="min-h-screen bg-[#060d18] text-slate-200">
      ...
      <header className="sticky top-0 z-40 border-b border-cyan-900/50 bg-[#0a1628]/95 backdrop-blur-sm">
        <div className="mx-auto flex w-full max-w-[1240px] items-center justify-between px-4 py-3 sm:px-6">
          <Link href="/" className="flex shrink-0 items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-black tracking-tight text-cyan-300 sm:text-xl">
                Aethelgard Sight
              </h1>
      ...
      <div className="mx-auto flex w-full max-w-[1240px] flex-col items-center gap-8 px-4 py-8 sm:px-6 sm:py-10">
        ...
        <div className="relative w-full max-w-[600px]">
          {/* Cable harnesses — top cables draping down */}
          ...
          <div className="relative rounded-[3rem] border-[4px] border-cyan-900 bg-gradient-to-b from-slate-800 via-slate-900 to-slate-950 p-6 shadow-[0_0_60px_rgba(8,145,178,0.08),inset_0_0_80px_rgba(0,0,0,0.5)] sm:p-8">
            {/* Metal banding strips with rivets */}
            ...
            <div className="relative mx-auto mb-4 mt-3 w-full max-w-[320px]">
              ...
              <div className="relative overflow-hidden rounded-[2rem] border-[3px] border-cyan-800/60 bg-gradient-to-b from-cyan-950/80 via-slate-900 to-cyan-950/80 shadow-[inset_0_0_60px_rgba(8,145,178,0.15)]">
                ...
                {/* Floating specimen orbs */}
                <div className="relative flex h-[200px] flex-col items-center justify-center gap-3 sm:h-[260px]">
                  {/* Specimen silhouette (abstract) */}
                  <div className="relative">
                    {/* Head orb */}
                    <div className="mx-auto h-10 w-10 rounded-full border-2 border-cyan-400/50 bg-cyan-500/20 shadow-[0_0_30px_rgba(8,145,178,0.3)] animate-pulse" />
                    {/* Body */}
                    <div className="mx-auto mt-1 h-16 w-12 rounded-t-[1.5rem] rounded-b-lg border-2 border-cyan-400/30 bg-cyan-500/10" />
                  </div>
                  
                  {/* Floating data ghosts */}
                  <div className="absolute top-4 left-8 text-[10px] font-mono text-cyan-500/40 animate-pulse">S-042</div>
                  <div className="absolute top-8 right-6 text-[10px] font-mono text-cyan-500/30 animate-pulse" style={{ animationDelay: '0.7s' }}>ACTIVE</div>
                  <div className="absolute bottom-12 left-12 text-[10px] font-mono text-cyan-500/20 animate-pulse" style={{ animationDelay: '1.4s' }}>NEURAL SCAN</div>
                </div>
              ...
              {/* Glass frame bolts */}
              <div className="absolute -left-1.5 top-8 h-3 w-3 rounded-full border border-cyan-600 bg-cyan-900 shadow-[0_0_6px_rgba(8,145,178,0.5)]" />
              <div className="absolute -left-1.5 bottom-8 h-3 w-3 rounded-full border border-cyan-600 bg-cyan-900 shadow-[0_0_6px_rgba(8,145,178,0.5)]" />
              <div className="absolute -right-1.5 top-8 h-3 w-3 rounded-full border border-cyan-600 bg-cyan-900 shadow-[0_0_6px_rgba(8,145,178,0.5)]" />
              <div className="absolute -right-1.5 bottom-8 h-3 w-3 rounded-full border border-cyan-600 bg-cyan-900 shadow-[0_0_6px_rgba(8,145,178,0.5)]" />
            </div>
          ...
          {/* Bottom pipes connecting pod to terminal */}
          ...
          <div className="relative rounded-[1.8rem] border-2 border-slate-700 bg-gradient-to-b from-slate-800 to-slate-900 p-5 shadow-[0_6px_0_rgba(30,41,59,1),inset_0_2px_10px_rgba(0,0,0,0.5)] sm:p-6">
            ...
            <div className="relative overflow-hidden rounded-[1.2rem] border-2 border-slate-600 bg-slate-950 p-4 shadow-[inset_0_0_30px_rgba(0,0,0,0.8)]">
              ...
              <div className="relative z-10 space-y-2 font-mono text-sm">
                ...
                <input
                  type="text"
                  value={accessCode}
                  onChange={(e) => setAccessCode(e.target.value.toUpperCase().slice(0, 12))}
                  placeholder="_ _ _ _ _ _ _ _ _ _ _ _"
                  maxLength={12}
                  className="w-full border-0 border-b-2 border-cyan-700 bg-transparent px-1 py-2 font-mono text-lg tracking-[0.3em] text-cyan-300 placeholder-slate-700 outline-none focus:border-cyan-400 transition-colors"
                />
            ...
            <div className="mt-4 flex gap-3">
              <button
                ...
                className="flex-1 rounded-xl border-2 border-slate-600 bg-slate-800 py-2 text-[11px] font-bold uppercase tracking-[0.2em] text-slate-400 transition hover:border-slate-500 hover:bg-slate-700 hover:text-slate-300 active:translate-y-0.5"
              >
                CLEAR
              </button>
              <button
                onClick={() => {
                  if (accessCode.length > 0) {
                    setAccessCode('CODE SUBMITTED — PROCESSING...');
                    setTimeout(() => setAccessCode(''), 2000);
                  }
                }}
                className="flex-[2] rounded-xl border-2 border-cyan-800 bg-cyan-950 py-2 text-[11px] font-bold uppercase tracking-[0.2em] text-cyan-400 shadow-[0_3px_0_rgba(14,116,144,1)] transition hover:bg-cyan-900 hover:text-cyan-300 active:translate-y-1 active:shadow-[0_0px_0_rgba(14,116,144,1)]"
              >
                EXECUTE
              </button>
            </div>
...
// ── Inline profile panel (same as before, imports at bottom) ──
    ...
    <>
      ...
      <div className="space-y-4">
        ...
        <form action="/auth/signout" method="post">
          <button className="flex w-full items-center justify-center gap-2 rounded-2xl border-2 border-slate-600 bg-slate-800 px-6 py-3 font-bold text-slate-400 transition-all duration-150 hover:bg-slate-700 hover:text-slate-300" type="submit">
